package br.com.entra21.oop.class_02.polymorphism;

public class Nadador extends PessoaAtleta implements Atleta {
	...
	public Nadador(String nome, byte idade, String ambiente, String equipamento) {
