...
public class Humano extends Information implements Evolucao {
	...
	public Humano(String nome, String nomeCientifico) {
	...
	public void meioAmbiente(String ambiente) {
		System.out.println("I'm a human and I live in " +ambiente);
	}

	@Override
	public void modoDeLocomover(String locomocao) {
		System.out.println("I'm a human and I move " +locomocao);
	}

	@Override
	public void alimetacao(String alimento) {
		System.out.println("I'm a human and I eat " +alimento);
	}
